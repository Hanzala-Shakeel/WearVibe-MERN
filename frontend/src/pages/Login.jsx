...
const Login = () => {
  ...
  function handleSubmit(e) {
    ...
    if (email && password) {
      axios
        .post(
          "https://wearvibe-backend.vercel.app/user/login",
          { email, password },
          ...
          <div className="w-1/3 px-20 py-10 max-sm:w-full max-sm:px-5 max-sm:py-20 max-md:w-[80%] max-lg:w-[60%] max-xl:w-1/2 max-2xl:w-[40%] rounded-md">
            ...
            >
              ...
              <input
                ...
                required
              />
              <button type="submit" className="px-5 rounded-full py-2 mt-2 bg-blue-500 text-white max-sm:text-sm max-sm:px-3">
                Login
              </button>
            </form>
          </div>
